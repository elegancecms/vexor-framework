...
abstract class Controller
{
    ...
    protected function validate(Request $request, array $rules): array
    {
        ...
        if (!empty($errors)) {
            throw new \Vexor\Exceptions\ValidationException($errors);
        }
    ...
    protected function auth(): \Vexor\Auth\AuthManager
    {
        return $this->app->make(\Vexor\Auth\AuthManager::class);
    }
    ...
    protected function security(): \Vexor\Security\SecurityManager
    {
        return $this->app->make(\Vexor\Security\SecurityManager::class);
    }
